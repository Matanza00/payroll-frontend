...
import { useCreateTaxMutation } from '../../services/taxManagementSlice';
import useToast from '../../hooks/useToast';
import LoadingButton from '../../components/LoadingButton';

const TaxManagementAddForm = () => {
  ...
  const [AddTaxManagement, { isLoading }] = useCreateTaxMutation();
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      await AddTaxManagement({
        ...formValues,
        amount: parseFloat(formValues.amount),
      }).unwrap();
      showSuccessToast('Tax Management Record Added Successfully!');
      navigate(-1);
    } catch (err) {
      showErrorToast('An error occurred while adding tax management record');
    }
  };
...
export default TaxManagementAddForm;
